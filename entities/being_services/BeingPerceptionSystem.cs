...
public class BeingPerceptionSystem
{
    ...
    private readonly Dictionary<Vector2I, Dictionary<string, object>> _memory = new ();
    private readonly Dictionary<Vector2I, uint> _memoryTimestamps = new ();
