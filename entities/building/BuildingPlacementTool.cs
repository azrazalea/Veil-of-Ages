...
namespace VeilOfAges.Entities
{
    ...
    public partial class BuildingPlacementTool : Node
    {
        ...
        private Color _validColor = new Color(0, 1, 0, 0.5f); // Green, semi-transparent
        private Color _invalidColor = new Color(1, 0, 0, 0.5f); // Red, semi-transparent
        ...
        {
            if (_currentTemplate == null || _gridArea == null) return;
