...
namespace VeilOfAges.UI
{
    ...
    {
        /// <summary>
        /// Text to display on the dialogue button
        /// </summary>
        public string Text { get; private set; }
        /// <summary>
        /// What command should be assigned to the Being spoken to upon clicking the button
        /// </summary>
        ...
        /// </summary>
        private bool _isSimpleOption = false;
        ...
        {
            if (_isSimpleOption) return _defaultSuccessResponse;
        ...
        {
            if (_isSimpleOption) return _defaultFailureResponse;
